public class Array3 
{
    ...
    public static void main(String args[]) 
    {
        ...
        for (int i [] : arrx)
        {
            ...
            System.out.println("Jumlah semua Data dalam Array Adalah : " + Jumlah);
    }
} 

/*coding diatas merupakan program untuk mencoba array dua dimensi lalu mencari 
hasil dari data yang di dalam array */ 